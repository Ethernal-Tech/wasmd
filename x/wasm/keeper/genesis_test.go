...
func setupKeeper(t *testing.T) (*Keeper, sdk.Context, []sdk.StoreKey) {
	...
	srcKeeper := NewKeeper(encodingConfig.Marshaler, keyWasm, pk.Subspace(wasmTypes.ModuleName), authkeeper.AccountKeeper{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, tempDir, wasmConfig, SupportedFeatures)
